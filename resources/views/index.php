	...
	<body>
		...
		<div  ng-controller="employeesController">
			...
			<table class="table">
				...
				<tbody>
					<tr ng-repeat="employee in employees" id="tr-{{ employee.id }}">
						<td>{{  employee.id }}</td>
						<td>{{ employee.name }}</td>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary" id="btn-save" ng-click="save(modalstate, id)" ng-disabled="frmEmployees.$invalid">
								Save changes
							</button>
						</div>
					</div>
